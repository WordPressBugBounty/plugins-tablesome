...
if (!class_exists('\Tablesome\Includes\Actions')) {
    class Actions
    {
        ...
        public function __construct()
        {
            ...
            add_action('admin_action_duplicate_the_tablesome_table', [$this, 'duplicate_table'], 10, 1);
            add_action('admin_action_empty_the_tablesome_table', [$this, 'empty_table'], 10, 1);
            add_action('admin_action_create_new_email_logs_trigger_table', [$this, 'create_new_email_logs_trigger_table'], 10, 1);
            add_action('admin_action_publish_table', [$this, 'publish_table'], 10, 1);
            add_action('admin_action_redirect_to_table', [$this, 'redirect_to_table'], 10, 1);
            ...
            add_action("csf_{$tablesome_csf_prefix}_saved", [$this, 'dispatch_save_settings_event'], 10, 1);
        }
        ...
        public function init_hook()
        {
            ...
            if (!is_admin() && !$is_login_page && !wp_doing_ajax() && !$is_rest_request && !headers_sent()) {
                ...
                setcookie('tablesome_redirect_token', $this->redirect_token, 0, COOKIEPATH, COOKIE_DOMAIN, is_ssl(), false);
            }
            ...
            tablesome_fs()->add_action('after_license_change', [$this, 'after_plan_change'], 10, 2);
        ...
        public function handle_admin_assets()
        {
            ...
            if ($should_load_freemius_styles) {
                wp_enqueue_style('fs_common', fs_asset_url(WP_FS__DIR_CSS . '/' . trim('/admin/common.css', '/')), [], false, 'all');
            }
        ...
        {
            wp_register_style($bundle_name, TABLESOME_URL . 'assets/bundles/public.bundle.css', [], TABLESOME_VERSION, 'all');
            wp_register_script($bundle_name, TABLESOME_URL . 'assets/bundles/public.bundle.js', ['jquery'], TABLESOME_VERSION, false);
        }

        private function register_and_enqueue_workflow_scripts()
        {
            wp_register_script(TABLESOME_DOMAIN . '-workflow-bundle', TABLESOME_URL . 'assets/bundles/workflow.bundle.js', ['jquery'], TABLESOME_VERSION, false);
        ...
        {
            wp_register_style($bundle_name, TABLESOME_URL . 'assets/bundles/admin.bundle.css', [], TABLESOME_VERSION, 'all');
            wp_register_script($bundle_name, TABLESOME_URL . 'assets/bundles/admin.bundle.js', ['jquery'], TABLESOME_VERSION, false);
        ...
        private function should_load_api_credentials()
        {
            ...
            $allowed_pages = array(
                'tablesome-settings',      // Settings page where integrations are configured
                'tablesome_admin_page',    // Table editor page where workflows are configured
            );
        ...
        public function enqueue_shortcode_builder_script()
        {
            ...
            wp_enqueue_script($bundle_name, TABLESOME_URL . 'assets/bundles/shortcodebuilder.bundle.js', ['jquery'], TABLESOME_VERSION, false);
        ...
        {
            add_submenu_page(
                'edit.php?post_type=' . TABLESOME_CPT, /* main menu slug */
                $submenu_page["title"], /* page title */
                $submenu_page["menu"], /* page submenu title */
                'manage_categories', /* page roles and capability needed*/
                $submenu_page["name"], /* page name */
                array($submenu_page["callback"]["controller"], $submenu_page["callback"]["method"]) /*page callback function */
            );
        }
        ...
        public function print_triggers_actions_collection()
        {
            ...
            ?>
            <script>
                window.tablesomeTriggers = <?php echo wp_json_encode($enqueue_data) ?> ;
            </script>
...
// echo $script;
        ...
        public function print_tables_collection()
        {
            ...
            <script type='text/javascript'>
                window.tablesomeTables = <?php echo $json_data ?> ;
            </script>
    <?php
}
        ...
        public function get_tables_count_collection()
        {
            ...
            if (!tablesome_fs()->can_use_premium_code__premium_only()) {
        ...
        public function get_email_logs_trigger_table_info()
        {
            ...
            if ($email_logs_trigger_publish_table_id) {
                ...
                $url = wp_nonce_url(
                    ...
                    TABLESOME_PLUGIN_BASE,
                    'tablesome_redirect_to_table_nonce'
                );
                $url = str_replace('&amp;', '&', $url);
            ...
            } else if ($email_logs_trigger_draft_table_id) {
                $url = wp_nonce_url(
                    add_query_arg(
                        array(
                ...
                $url = wp_nonce_url(
                    ...
                    TABLESOME_PLUGIN_BASE,
                    'tablesome_email_logs_trigger_table_nonce'
                );
        ...
        public function get_onboarding_url($status)
        {
            ...
            $onboarding_page_url = $pluginator_security_agent->add_query_arg(array('link_action' => 'EMAIL_LOGS'), $onboarding_page_url);
            $onboarding_page_url = $pluginator_security_agent->add_query_arg(array('status' => $status), $onboarding_page_url);
